    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'pgsql_identity' => [
                ...
                'username' => env('DB_IDENTITY_USERNAME', 'app'),
            ...
            'pgsql_core' => [
                ...
                'database' => env('DB_CORE_DATABASE', 'core_db'),
                'username' => env('DB_CORE_USERNAME', 'app'),
            ...
            'pgsql_knowledge' => [
                'driver' => 'pgsql',
                'host' => env('DB_KNOWLEDGE_HOST', '127.0.0.1'),
                'port' => env('DB_KNOWLEDGE_PORT', '5432'),
                'database' => env('DB_KNOWLEDGE_DATABASE', 'knowledge_db'),
                'username' => env('DB_KNOWLEDGE_USERNAME', 'app'),
                'password' => env('DB_KNOWLEDGE_PASSWORD', ''),
                'charset' => 'utf8',
                'prefix' => '',
                'prefix_indexes' => true,
                'search_path' => 'public',
            ...
            'pgsql_audit' => [
                ...
                'username' => env('DB_AUDIT_USERNAME', 'app'),
